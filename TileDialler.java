...
{
	public int x, y, z;
	public IStargate ownedGate = null;
	...
	{
		return new String[]{"dialGate", "hasGate", "findAddress","toggleIris"};
	}
	...
	public Object[] callMethod(IComputerAccess computer, int method, Object[] arguments) throws Exception
	{
		switch (method)
		{
			...
			case 3:
				return new Object[]{toggleIris(computer,(Boolean)arguments[0])};
			default:
				return new Object[0];
		}
	}
	...
	public boolean toggleIris(IComputerAccess computer, boolean desiredState)
	{
		if(!hasGate()) return false;
		if(desiredState)
		{
			worldObj.getClosestPlayer(x,y,z,4.00).addChatMessage("Iris closed.");
		}
		else
		{
			worldObj.getClosestPlayer(x,y,z,4.00).addChatMessage("Iris opened.");
		}
		ownedGate.setIrisState(desiredState);
		return true;
	}
