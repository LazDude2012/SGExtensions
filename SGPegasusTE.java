...
public class SGPegasusTE extends SGBaseTE implements IInventory,IStargate
{
...
//	double ringVelocity; // degrees per tick
	...
	public static SGPegasusTE at(IBlockAccess world, int x, int y, int z)
	{
		TileEntity te = world.getBlockTileEntity(x, y, z);
		if (te instanceof SGPegasusTE)
			return (SGPegasusTE) te;
		else
			return null;
	}

	public static SGPegasusTE at(SGLocation loc)
	{
		if (loc != null)
		{
			World world = DimensionManager.getWorld(loc.dimension);
			if (world != null)
				return SGPegasusTE.at(world, loc.x, loc.y, loc.z);
		}
		return null;
	}

	public static SGPegasusTE at(IBlockAccess world, NBTTagCompound nbt)
	{
		return SGPegasusTE.at(world, nbt.getInteger("x"), nbt.getInteger("y"), nbt.getInteger("z"));
	}
...
//	}
	...
	public void connectOrDisconnect(String address, EntityPlayer player)
	{
		...
		} else
		{
			...
			IStargate dte = getConnectedStargateTE();
	...
	void connect(String address, EntityPlayer player)
	{
		...
		IStargate dte = SGAddressing.findAddressedStargate(address);
	...
	public void disconnect()
	{
		...
		SGPegasusTE dte = SGPegasusTE.at(connectedLocation);
		if (dte != null)
			dte.clearConnection();
		clearConnection();
	}
	...
	public void startDiallingStargate(String address, IStargate dte, boolean initiator)
	{
...
//	}
	...
	public IStargate getConnectedStargateTE()
	{
		if (connectedLocation != null)
