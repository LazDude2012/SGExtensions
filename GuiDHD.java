...
public class GuiDHD extends SGScreen
{
	...
	public GuiDHD(EntityPlayer player, World world, int x, int y, int z)
	{
		this.world = world;
		this.x = x;
		this.y = y;
...
//	}
	...
	{
		//System.out.printf("GuiDHD.mouseClicked: %d, %d, %d\n", x, y, mouseButton);
		if (mouseButton == 0)
		{
	...
	{
		//System.out.printf("GuiDHD.findDHDButton: mx = %d, my = %d, cx = %d, cy = %d\n",
		//	mx, my, dhdCentreX, dhdCentreY);
		int x = -(mx - dhdCentreX);
		int y = -(my - dhdCentreY) * dhdWidth / dhdHeight;
		//System.out.printf("GuiDHD.findDHDButton: x = %d, y = %d\n", x, y);
		...
		//System.out.printf("GuiDHD.findDHDButton: a = %s\n", a);
		if (a < 0)
			a += 360;
	...
	{
		//System.out.printf("GuiDHD.dhdButtonPressed: %d\n", i);
		buttonSound();
		if (i == 0)
	...
	{
		bindTexture("/sgextensions/resources/dhd_gui.png");
		drawTexturedRect((width - dhdWidth) / 2, height - dhdHeight, dhdWidth, dhdHeight);
	}

	void drawOrangeButton()
	{
		bindTexture("/sgextensions/resources/dhd_centre.png", 128, 64);
